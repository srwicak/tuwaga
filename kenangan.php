...
<html>
    ...
    <body>
        <div id="main">
            <div id="content">
                <div class="header">
                    <a id="logo" href="http://www.idhostinger.com/"><img src="http://www.idhostinger.com/images/logo-id.png" alt="Web hosting" /></a>
                </div>
                <div class="content">
                    ...
                    <p>Berikut adalah daftar file Anda yang berada di folder public_html:</p>
                    <div id="files">
                        <div class="top"></div>
                        <div class="cont">
